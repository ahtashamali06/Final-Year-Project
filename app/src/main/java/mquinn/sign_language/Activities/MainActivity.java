...
public class MainActivity extends Activity implements CvCameraViewListener2 {
    ...
    private Button btnAdd, btnClear, btnBack, btnSend;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if (!modLetter.equals("?"))
                    ...
                    Message = txtView.getText().toString().trim();
            }
        });
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Shared Pref
                if (Message!=null){
                    SharedPreferences sharedPreferences = getSharedPreferences("MessageSharedPreference",MODE_PRIVATE);
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.putString("Converted_Message",Message);
                    editor.commit();
                    Intent intent = new Intent(MainActivity.this,Home_Activity.class);
                    startActivity(intent);
                }else
                    Toast.makeText(MainActivity.this, "Empty Message", Toast.LENGTH_LONG).show();
            }
        });
