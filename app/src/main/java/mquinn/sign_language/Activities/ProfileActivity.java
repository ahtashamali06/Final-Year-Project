...
//         Check User Exist
                ...
                if (snapshot.exists()){
                    ...
                    if (user != null){
                        if (user.getPhotoUrl() != null){
                            Glide.with(getApplicationContext()).load(user.getPhotoUrl()).into(profile);
                        }
                    }
        ...
        clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ProfileActivity.this, "Data Deleted successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(),Home_Activity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK| Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
            }
    ...
    private void setUserProfileUri(Uri uri){
        ...
        user.updateProfile(request).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(ProfileActivity.this, "Profile Image Updateion Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}